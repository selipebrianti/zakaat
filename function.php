<?php
// Koneksi Database
$koneksi = mysqli_connect("localhost", "root", "", "irfanzakat");
...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nis','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$jumlah','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', jumlah = '$jumlah', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nik = $nik";
