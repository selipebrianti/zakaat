...
if (isset($_POST['simpan'])) {
    if (tambah($_POST) > 0) {
        echo "<script>
                alert('Data zakat berhasil ditambahkan!');
                document.location.href = 'index.php';
            </script>";
    } else {
        // Jika fungsi tambah dari 0/data tidak tersimpan, maka munculkan alert dibawah
        echo "<script>
                alert('Data zakat gagal ditambahkan!');
            </script>";
    }
}
...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Zakat</a>
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <input type="text" class="form-control w-50" id="jenis" name="jenis" required>
                         </div>
                         <div class="mb-3">
                              <label for="jumlah" class="form-label">Jumlah</label>
                              <input type="text" class="form-control w-50" id="jumlah"
                                   placeholder="Masukkan Jumlah" name="jumlah" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Data Zakat'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
